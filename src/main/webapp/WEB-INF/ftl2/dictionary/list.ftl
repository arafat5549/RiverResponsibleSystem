                ...
                <div class="col-md-12">
                    ...
                    <div class="portlet">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-user"></i>数据字典列表
                            </div>
                        </div>
                        <!-- 检索  -->
                        <form class="form-inline" role="form" id="searchForm" action="/dictionary/export"  onchange="search(this.id)">
                            <table class="table">
                                <tr>
                                    <td>
                        ...
                        <div class="portlet-body">
                            <div class="table-container">
                                <div class="table-actions-wrapper">
                                    <button class="btn btn-add blue table-group-action-submit" id="dictionary-add"
                                            data-toggle="modal" onclick="javascript:Dictionary.add_click();"> 新增
                                    </button>
                                </div>
...
<#include "../jslib.ftl" >
<script src="${BasePath}/scripts/custom/dictionary.js"></script>
<script>
