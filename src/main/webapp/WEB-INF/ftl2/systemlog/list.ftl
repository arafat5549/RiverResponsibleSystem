				...
				<div class="col-md-12">
					...
					<div class="portlet">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-user"></i>系统日志列表
							</div>						
						</div>
                        <!-- 检索  -->
                        <form class="form-inline" role="form" id="searchForm" action="/systemLog/export" onchange="search(this.id)">
                            <table class="table">
                                <tr>
                                    <td>
                                    ...
                                    <td>
                                        <div class="form-group">
                                           <#-- <label class="col-sm-pull-2 control-label" for="isAdmin">类型-->
						...
						<div class="portlet-body">
							<div class="table-container">
								<div class="table-actions-wrapper">
									<button class="btn btn-add blue table-group-action-submit" id="systemLog-add" data-toggle="modal" onclick="javascript:SystemLog.add_click();"> 新增</button>
								</div>
...
<#include "../jslib.ftl" >
<script src="${BasePath}/scripts/custom/systemLog.js"></script>
<script>
