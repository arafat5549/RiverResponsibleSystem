var DataTableCl = function () {
    var handleDeviceinfoLog = function(ol) {
        ...
        grid.init({
            ...
            dataTable: {  // here you can define a typical datatable settings from http://datatables.net/usage/options
                ...
                "sAjaxSource": "getDeviceinfoLogDataTables.do", // ajax source
	...
	return {
		...
		update: function(){
			...
			Cl.ajaxRequest(url,data,function(result){
				...
				if(result == "success"){			
					Cl.hideModalWindow(Cl.modalName);
					Cl.updateDataRow(DataTableCl.tableName,data.id,0,'getDeviceinfoLogDataRow.do');
					alert("修改成功");
				} else {
					alert("修改失败");
					return ;			
