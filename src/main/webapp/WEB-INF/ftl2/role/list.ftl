			...
			<div class="row">
				<div class="col-md-12">
					...
					<div class="portlet">
                        ...
                        <!-- 检索  -->
                        <form class="form-inline" role="form" id="searchForm" action="/role/export" onchange="search(this.id)">
                            <table class="table">
                                <tr>
                                    <td>
...
<script>
        ...
        //jQuery.extend($.fn.dataTable.defaults, {"oLanguage":oLanguage} );
	jQuery(document).ready(function() {       
	   // initiate layout and plugins
	   App.init();
	   Cl.initModal();
	   //console.log(Cl.oLanguage)
