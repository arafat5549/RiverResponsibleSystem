				...
				<div class="col-md-12">
					...
					<div class="portlet">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-user"></i>品牌列表
							</div>						
						</div>
                        <!-- 检索  -->
                        <form class="form-inline" role="form" id="searchForm" action="/brand/export" onchange="search(this.id)">
                            <table class="table">
                                <tr>
                                    <td>
						...
						<div class="portlet-body">
							<div class="table-container">
								<div class="table-actions-wrapper">
									<button class="btn btn-add blue table-group-action-submit" id="brand-add" data-toggle="modal" onclick="javascript:Brand.add_click();"> 新增</button>
								</div>
...
<#include "../jslib.ftl" >
<script src="${BasePath}/scripts/custom/brand.js"></script>
<script>
