...
public class StringUtil
{
     ...
     *
     */
    public static <T> String parseDataRow(T t,boolean flags[]) {
         //1 2 4 8
        if(t==null || flags==null)
          return "";
        StringBuffer sb = new StringBuffer();
        Object id = ReflectionUtil.getFieldValue(t,"id");
        ...
        for(int i=0;i<flags.length;i++){
          if(flags[i]){
              switch (i){
                case 2:
                  sb.append("<a href=\\\"javascript:"+objname+".update_click('").append(id).append("');\\\" class=\\\"btn btn-xs default btn-editable\\\"><i class=\\\"fa fa-edit\\\"></i> 修改</a>");
                  break;
                case 1:
                  sb.append("&nbsp;&nbsp;<a href=\\\"javascript:"+objname+".remove('").append(id).append("');\\\" class=\\\"btn btn-xs default btn-editable\\\"><i class=\\\"fa fa-times\\\"></i> 删除</a>");
                  break;
                case 3://查询
                  break;
//                case 4://
//                  //先判断是否有这个字段
//                  Field field = ReflectionUtil.getAccessibleField(t, "isLock");
//                  if(field != null)
//                  {
//                      Boolean haslock = (Boolean)ReflectionUtil.getFieldValue(t,"isLock");
//                      sb.append("&nbsp;&nbsp;<a href=\\\"javascript:").append(haslock ? "User.unlock('" : "User.lock('").append(id).append("');\\\" class=\\\"btn btn-xs default btn-editable\\\"><i class=\\\"fa fa-").append(haslock ? "un" : "").append("lock\\\"></i> ").append(haslock ? "解锁" : "锁定").append("</a>");
//                  }
//                  break;
//                case 5:
//                  sb.append("&nbsp;&nbsp;<a href=\\\"javascript:User.assign_click('").append(id).append("');\\\" class=\\\"btn btn-xs default btn-editable\\\"><i class=\\\"fa fa-key\\\"></i> 分配角色</a>");
//                  break;
              }
          }
