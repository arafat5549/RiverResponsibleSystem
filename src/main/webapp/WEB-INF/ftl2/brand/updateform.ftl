				...
				<div class="form-body">
					<div class="form-group">
						...
						<div class="col-md-8">
							...
							<input type="text" id="name" name="name" value="${brand.name}" data-required="1" class="form-control"/>
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-md-8">
							<input type="text" id="ename" name="ename" value="${brand.ename}" data-required="1" class="form-control"/>
						</div>
					</div>				
					<div class="form-group">
						...
						<div class="col-md-8">
							<input type="text" id="website" name="website" value="${brand.website}" data-required="1" class="form-control"/>
						</div>
					</div>
				<#--	<div class="form-group">
